Rails.application.routes.draw do
  ...
  resources :brands, only: [:index, :show, :create, :destroy] do
    get 'count', on: :collection
  end

  get 'brands/range/:index', to: 'brands#range'
  get 'brands/range/:index/:count', to: 'brands#range_count'
  ...
  get 'categories/range/:index/:count', to: 'categories#range_count'
  ...
  get 'products/range/:index/:count', to: 'products#range_count'
